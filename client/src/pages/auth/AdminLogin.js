      ...
      if (!isValidEmail(userDetails.email)) {
        ...
        try {
          ...
          if (result.data.userDetails.userType === 'university') {
            if (
              result.data.userDetails.isVerified &&
              result.data.userDetails.isVerified == 'verified'
            ) {
              ...
              result.data.userDetails.isVerified &&
              result.data.userDetails.isVerified == 'rejected'
            ) {
              setSnackbarType('error');
              setSnackbarMsg(
          ...
          } else if (result.data.userDetails.userType === 'admin') {
            setSnackbarType('success');
            setSnackbarMsg('Logged In Successfully');
            handleOpenSnackbar();
            // let decodedToken = jwt_decode(result.data.token)
